...
const News = (props) => {
  ...
  const updateNews = async () =>{
    ...
    useEffect(() => {
      document.title =`${capitalizeFirstLetter(props.category)} - NewsDoseDaily`;
      updateNews()
  ...
  // }
   ...
   const fetchMoreData = async ()=>{
    ...
    return (
      <>
       <h1 className="text-center" style={{margin: '35px 0px',marginTop: '70px'}}>NewsDoseDaily - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
       {loading && <Spinner/>}
       <InfiniteScroll
